...
namespace ApiApprover
{
    public class PublicApiGenerator
    {
        ...
        private static void AddMemberToClassDefinition(CodeTypeDeclaration genClass, MemberInfo memberInfo)
        {
        ...
        private static CodeTypeDeclaration CreateClassDeclaration(Type publicType)
        {
        ...
        private static string GenerateClassCode(StringWriter writer)
        {
        ...
        private static CodeTypeMember GenerateEvent(EventInfo memberInfo)
        {
        ...
        private static CodeTypeMember GenerateField(FieldInfo memberInfo)
        {
